...
EWGREENLIGHT:
    ...
    BTFSC LIGHTMODE, 7	    ;IF NSCARS FLAG IS SET, CHANGE TO YELLOW
    GOTO EWGTOY
    BTFSS LIGHTMODE, 6	    ;ELSEIF EWCARS FLAG IS CLEARED, CHANGE TO YELLOW
    GOTO EWGTOY
    
    BCF LIGHTMODE, 6	    ;ELSE, CLEAR EWCARS FLAG, RESET GRNCOUNT, RETURN
    MOVLW H'05'
    MOVWF GRNCOUNT
    RETFIE
    
EWGTOY:			    ;EAST WEST CHANGE FROM GREEN TO YELLOW
    BCF LIGHTMODE, 7	    ;CLEAR THE NSCARS FLAG
    BCF PORTC, RC3	    ;TURN OFF GREEN LIGHT
    BSF PORTC, RC4	    ;TURN ON YELLOW LIGHT
    RETFIE
    
    
NSYELLOWLIGHT:
    BCF PORTC, RC1	    ;TURN OFF YELLOW LIGHT
    BSF PORTC, RC2	    ;TURN ON RED LIGHT
    BCF PORTC, RC5	    ;TURN OFF E/W RED LIGHT
    BSF PORTC, RC3	    ;TURN ON E/W GREEN LIGHT
    
    MOVLW H'05'		    ;RESET GRNCOUNT, RETURN FROM INTERRUPT
    MOVWF GRNCOUNT
    RETFIE
    
EWYELLOWLIGHT:
    BCF PORTC, RC4	    ;TURN OFF YELLOW LIGHT
    BSF PORTC, RC5	    ;TURN ON RED LIGHT
    BCF PORTC, RC2	    ;TURN OFF N/S RED LIGHT
    BSF PORTC, RC0	    ;TURN ON N/S GREEN LIGHT
