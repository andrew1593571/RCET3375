...
INTERRUPT:
    ...
    BTFSC PIR1, TXIF	    ;IF UART TRANSMIT INTERRUPT, GOTO UARTTRANSMIT ISR
    GOTO UARTTRANSMIT
...
TMR2ISR:
    ...
    MOVLW H'09'		    ;LOAD MSB OF PULSE SPACE COUNT
    MOVWF COUNTMSB	    
    MOVLW H'C4'		    ;LOAD LSB OF PULSE SPACE COUNT
    MOVWF COUNTLSB
    RETFIE
    
STARTPW:
    MOVF SERVOPOS, W	    ;MOVE SERVOPOS INTO W, ADD 62
    ADDLW H'3E'
